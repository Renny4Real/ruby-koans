...
class AboutClassMethods < Neo::Koan
  ...
  # The second method is clearer in terms of comprehension and viewing. 
  # It also looks easier to define multiple methods under class << self definition
  # Rather than redefining self.method again and again
  # 

  # Are there times you might prefer one over the other?
  ## In the instance where I might need to create a subclass, the first method would make it easier to read subclass class methods better.
  ## since using the inheritance symbol '<<'' is a my preferred method. 
